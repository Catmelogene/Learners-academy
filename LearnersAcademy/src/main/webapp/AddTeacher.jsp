...
<form method="post" action="AddTeacher" class="mb-3">
	...
	<br>
	<label for="txtLastContactNumber">Contact Number</label>
	<input  type="tel" name="txtLastContactNumber" id="txtLastContactNumber" class="form-control" placeholder="">
	<br>
	<label for="txtEmail">Email</label>
	<input type="email" name="txtEmail" id="txtEmail" class="form-control" placeholder="@learnersacademy.com">
	<br><br>
